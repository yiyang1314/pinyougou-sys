...
app.service('orderService',function($http){
	...
	this.findOrder=function(){
		return $http.get('../order/payOrder.do');
	}
	//搜索
	this.findOrderOne=function(page,rows,searchEntity){
		return $http.post('../order/findOrderOne.do?page='+page+"&rows="+rows, searchEntity);
	}
