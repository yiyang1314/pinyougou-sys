...
import com.pinyougou.user.services.ProvincesService;
...
public class ProvincesServiceImpl implements ProvincesService {
	...
	public TbProvinces findOne(Long id){
		return provincesMapper.selectByPrimaryKey(id.intValue());
	}
	...
	public void delete(Long[] ids) {
		for(Long id:ids){
			provincesMapper.deleteByPrimaryKey(id.intValue());
		}		
	}
