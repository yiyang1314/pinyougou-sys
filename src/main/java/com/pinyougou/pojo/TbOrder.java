...
public class TbOrder implements Serializable{
	...
	public String toString() {
		return "TbOrder [orderId=" + orderId + ", payment=" + payment + ", status=" + status + ", createTime="
				+ createTime + ", shippingName=" + shippingName + ", shippingCode=" + shippingCode + ", userId="
				+ userId + ", buyerMessage=" + buyerMessage + ", receiver=" + receiver + ", sellerId=" + sellerId + "]";
	}
