...
import com.pinyougou.admin.services.ContentCategoryService;
...
public class ContentCategoryServiceImpl implements ContentCategoryService {
	...
	public PageResult findPage(TbContentCategory contentCategory, int pageNum, int pageSize) {
		...
		if(contentCategory!=null){			
			...
			if(contentCategory.getId()!=null && contentCategory.getId()>0){
				criteria.andNameLike("%"+contentCategory.getId()+"%");
			}
		}
